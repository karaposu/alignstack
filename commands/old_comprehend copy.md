...
**Paradigm Projection Check** — When comprehending something that measures, assesses, or evaluates (a metric system, a quality framework, an assessment tool), ask: "Does this mechanism measure what it claims to measure, or does it measure a proxy? Is the thing that actually matters quantifiable at all?" If the artifact's quality involves meaning, significance, or judgment rather than mechanism, your predictions about it may be confident but wrong — because Comprehend's measurement paradigm doesn't apply to meaning. Flag this as a frontier question for `/sense-making`.
